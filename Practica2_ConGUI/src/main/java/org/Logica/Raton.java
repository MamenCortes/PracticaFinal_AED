...
public class Raton implements Comparable<Raton>{
    ...
    /**
     * Edita la información adicional del ratón
    ...
    /**
     * Compara este ratón con el ratón especificado según su número de referencia de forma ascendente.
    ...
    public static void main(String[] args) throws IllegalArgument {
        ...
        String toCSV = raton.toCSV(",");
        String[] data = toCSV.split(",", 3);
        for(String s:data){
